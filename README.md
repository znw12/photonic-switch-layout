...
最新器件版参考 Nature 2018 的 TFLN GSG 设计，使用 **1 mm 四光端口 MZI**（有效电极段 680 μm、R≥20 μm），全片 **1 个公共地 + 832 个独立 S**。完整矩阵为 **36.394 × 10.853 mm**；几何已验证，2×2 耦合比例和光电性能待标定，见 [GSG MZI 设计与验证](docs/BENES_GSG_MZI.md)。

...
最新版本采用单带连续斜线、南北各三排 pad，同排中心距固定 100 μm、排间横向错位 25 μm、纵向排距 70 μm。压紧预留空白后为 **36.394 × 10.792 mm**，比两排版缩短 **12.90%**、面积减少 **8.63%**；见 [三排紧凑布局与验证](docs/BENES_THREE_ROW_ELECTRICAL.md)。

...
新增 [精确 100 路 AS-Beneš 版](docs/exact100-balanced.md)：596 个 MZI、南北各两排 100 μm 中心距/50 μm 错位 pad、逐列左右引线和共享 G 单接点，比较 34/35 μm 连续斜线连接，最终选择 34 μm，尺寸 **20.253 × 4.947 mm**，较原参考左右缩短 **9.84%**、面积减少 **0.53%**。

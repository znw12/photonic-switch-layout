...
最新紧凑版采用 **25 μm 光端口间距、局部地母线及南北各 4 个 G pad**，完整尺寸为 **22.463 × 4.484 mm**，面积比上一版减少 **74.5%**。保留 832 个独立 S pad、南北各三排 pad、同排最小中心距 120 μm、1 mm MZI 和 R≥20 μm；MZI 内的 S 引出改为直线。配置、验证结果与生成方法见 [25 μm 与局部共地版](docs/compact-gsg.md)。
